function About() {
  ...
  return (
    <main className="flex-grow">
      <section className="bg-stone-50/90">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 md:grid-cols-2 lg:px-8">
          ...
          <div>
            <p className="text-sm font-semibold uppercase tracking-widest text-green-900">About Isaac</p>
            <h2 className="mt-3 text-3xl font-bold text-stone-950 sm:text-4xl">Practical landscaping with a careful eye.</h2>
            ...
            <ul className="mt-6 grid gap-3">
              {principles.map((principle) => (
                <li key={principle} className="flex gap-3 text-stone-800">
                  <span className="mt-2 h-2 w-2 shrink-0 rounded-full bg-lime-600"></span>
                  <span>{principle}</span>
                </li>
              ))}
            </ul>
